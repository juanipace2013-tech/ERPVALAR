  ...
  try {
    ...
    const product = await prisma.product.update({
      ...
      data: {
        ...
        category: validatedData.categoryId ? { connect: { id: validatedData.categoryId } } : { disconnect: true },
        supplier: validatedData.supplierId ? { connect: { id: validatedData.supplierId } } : { disconnect: true },
